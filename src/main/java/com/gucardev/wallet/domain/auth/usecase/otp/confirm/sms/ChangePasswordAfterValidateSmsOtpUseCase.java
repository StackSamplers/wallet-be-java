...
public class ChangePasswordAfterValidateSmsOtpUseCase implements UseCaseWithParams<ChangePasswordConfirmRequest> {
    ...
    public void execute(ChangePasswordConfirmRequest params) {
        ...
        if (!validateOtpUseCase.execute(new ValidateOtpRequest(user.getPhoneNumber(), OtpType.CHANGE_PASSWORD, OtpSendingChannel.EMAIL, params.getOtp()))) {
