...
import com.gucardev.wallet.infrastructure.websocket.dto.ErrorResponse;
...
import com.gucardev.wallet.infrastructure.websocket.factory.WebSocketActionHandler;
...
public class CustomSecureWebSocketHandler extends AbstractWebSocketHandler {
    ...
    private void sendError(WebSocketSession session, String errorMessage) throws IOException {
        ...
        WebSocketMessage<ErrorResponse> message = new WebSocketMessage<>(WebSocketAction.ERROR, error);
