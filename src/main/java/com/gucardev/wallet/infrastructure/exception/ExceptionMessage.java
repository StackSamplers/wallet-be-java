...
public enum ExceptionMessage {
    ...
    UNEXPECTED_EXCEPTION("messages.error.default_message", HttpStatus.BAD_REQUEST, 999),
    ...
    WRONG_CREDENTIALS_EXCEPTION("messages.error.wrong_credentials_exception", HttpStatus.UNAUTHORIZED, 1004),
    INVALID_OTP_EXCEPTION("messages.error.default_message", HttpStatus.NOT_FOUND, 1005),
    ACCOUNT_LOCKED("messages.error.account_is_locked", HttpStatus.LOCKED, 1006),
